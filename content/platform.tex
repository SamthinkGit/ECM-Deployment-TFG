...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.5]{figs/icon-detection.png}
    \caption{\small Detección y graficado de iconos detectados en pantalla usando OpenCV y Pillow. Fuente: Elaboración Propia}
