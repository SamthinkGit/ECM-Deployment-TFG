% !TEX root = ms.tex
\chapter[Plataforma de Desarrollo]{Plataforma de \\ Desarrollo}
...
sin reestructurar el sistema completo sino que además deben poder configurarse 
...
entorno mediante simulación de entrada de teclado, clicks de ratón o
...
da la capacidad a la MCE para operar sobre sistemas operativos de
...
\begin{figure}[!h]
    ...
    \caption{\small Detección de iconos detectados en pantalla usando OpenCV y Pillow.}
