...
ha creado un diccionario de combinaciones de teclas que incluyen multiples representaciones
...
\todo{Añadir un diagrama aquí del funcionamiento del intérprete :D}
...
\begin{itemize}
    ...
    necesarias para cada agente. Una vez con estas dependencias, FastAP generá un entorno virtual
...
\todo{Otro diagrama por acá de FastAP con los agentes}
