...
herramientas son un conjunto de funciones o fragmentos de código que permiten 
que el LLM interactúe con su entorno. Gracias a esto, mientras que un LLM solo
puede generar una salida a partir de una consulta dada, los agentes traducen
esas salidas en acciones que modifican el mundo y, opcionalmente, la propia
...
cognitivo. En línea con estas arquitecturas, se define un \emph{agente cognitivo} 
como un agente del cual emergen capacidades cognitivas, y que es
capaz de interactuar, aprender y modificar su comportamiento o entorno.
...
interacción con el entorno, este término es comúnmente utilizado por entornos que
toman usos de agentes AGI como su funcionalidad principal (otros nombres comunes
incluyen IA autónoma, agentes AGI, etc.).
...
Múltiples enfoques han surgido en torno a la AGI. Algunas se centran
en especializar el conocimiento general en una aplicación específica, donde se
encapsula un agente cognitivo dentro de un entorno que guía a la IA informándola 
sobre el estado actual del entorno o las herramientas disponibles.
...
\section{Técnicas de Comportamiento para Arquitecturas Cognitivas}

En secciones anteriores se han explorado distintos entornos que aprovechan el 
potencial de arquitecturas agénticas. Sin embargo, para poder "configurar" estas
arquitecturas, se han plantado diversos métodos para modificar o \emph{tunear}
el comportamiento de una IA con el fin de que estos puedan implementarse con éxito.
A continuación, se destacan las técnicas clave en el estado del arte para
