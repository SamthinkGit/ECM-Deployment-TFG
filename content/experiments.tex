...
global entre los agentes para identificar tendencias generales y comportamientos
destacados. Con este fin, la siguiente tabla presenta un resumen de las métricas de 
cada agente a lo largo de los tres entornos evaluados.

\subsubsection{Tiempos de completado promedio}
...
La tabla \ref{tab:completion-rate} muestra cómo los agentes más simples,
como \emph{Planex} y \emph{PlanexV2}, completan con éxito únicamente el entorno
más básico. A medida que la complejidad aumenta, estos agentes fallan
de forma consistente al carecer de mecanismos robustos de recuperación, visión
o razonamiento adaptativo.

Por el contrario, los agentes de tipo \emph{FastReact}, y en particular sus
variantes visuales como \emph{V-FastReact} y \emph{DarkVFR}, logran una tasa
de completado del \textbf{100\%}, mostrando una mayor capacidad de adaptación
a entornos desconocidos o cambiantes.

En cuanto al consumo de recursos, especialmente el número de tokens procesados
por cada agente en sus interacciones, se han observado diferencias notables
que serán analizadas en la sección posterior. Este aspecto es fundamental para
valorar la eficiencia cognitiva y computacional de cada arquitectura.

Por último, es importante destacar que aunque agentes como \emph{Xplore} o
\emph{FastReact} no completan todas las tareas, sí muestran estrategias 
flexibles y comportamientos interesantes que pueden resultar relevantes para
su reutilización o mejora en futuras iteraciones.

Este análisis global permite establecer una primera noción del balance entre
simplicidad arquitectónica y robustez adaptativa, cuestión que será retomada 
en el capítulo de conclusiones con mayor profundidad.
